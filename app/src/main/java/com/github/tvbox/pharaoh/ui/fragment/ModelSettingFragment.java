package com.github.tvbox.pharaoh.ui.fragment;
...
import com.github.tvbox.pharaoh.api.ApiConfig;
import com.github.tvbox.pharaoh.base.BaseActivity;
import com.github.tvbox.pharaoh.base.BaseLazyFragment;
import com.github.tvbox.pharaoh.bean.IJKCode;
import com.github.tvbox.pharaoh.bean.SourceBean;
import com.github.tvbox.pharaoh.ui.activity.SettingActivity;
import com.github.tvbox.pharaoh.ui.adapter.SelectDialogAdapter;
import com.github.tvbox.pharaoh.ui.dialog.AboutDialog;
import com.github.tvbox.pharaoh.ui.dialog.ApiDialog;
import com.github.tvbox.pharaoh.ui.dialog.BackupDialog;
import com.github.tvbox.pharaoh.ui.dialog.SelectDialog;
import com.github.tvbox.pharaoh.ui.dialog.XWalkInitDialog;
...
public class ModelSettingFragment extends BaseLazyFragment {
    ...
    protected void init() {
        ...
        tvApi.setText(Hawk.get(HawkConfig.API_URL, "https://pubjs.s3.bitiful.net/tvbox/a.json?a"));
        tvDns.setText(OkGoHelper.dnsHttpsList.get(Hawk.get(HawkConfig.DOH_URL, 0)));
        tvHomeRec.setText(getHomeRecName(Hawk.get(HawkConfig.HOME_REC, 1)));
        tvSearchView.setText(getSearchView(Hawk.get(HawkConfig.SEARCH_VIEW, 0)));
        tvHomeApi.setText(ApiConfig.get().getHomeSourceBean().getName());
        tvScale.setText(PlayerHelper.getScaleName(Hawk.get(HawkConfig.PLAY_SCALE, 1)));
        ...
        findViewById(R.id.llScale).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FastClickCheckUtil.check(v);
                int defaultPos = Hawk.get(HawkConfig.PLAY_SCALE, 1);
        ...
        findViewById(R.id.llHomeRec).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FastClickCheckUtil.check(v);
                int defaultPos = Hawk.get(HawkConfig.HOME_REC, 1);
